...
public class App {
    ...
    public static void main(String[] args) {
        ...
        Object videoIndexerClient = null; // new VideoIndexerClient(ArmAccessTokenPermission.Contributor, ArmAccessTokenScope.Account);

        //3. Get Account Information
        Account account = null; // videoIndexerClient.getAccountInfo();
